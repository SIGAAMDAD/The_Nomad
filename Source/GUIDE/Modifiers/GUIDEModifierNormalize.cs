...
namespace GUIDE {
	...
	*/
	...
	[Tool]
	public sealed partial class GUIDEModifierNormalize : GUIDEModifier {
		public override string? EditorName => "Normalize";
		public override string? EditorDescription => "Normalizes the input vector.";
