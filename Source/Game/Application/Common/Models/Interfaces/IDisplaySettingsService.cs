...
namespace Game.Application.Common.Models.Interfaces {
	public interface IDisplaySettingsService {
		IDisplayConfiguration Config { get; }
		WindowSize NativeResolution { get; }
		...
		string[] GetSupportedVSyncModes();
		string[] GetSupportedAntiAliasingModes();
		string[] GetSupportedAspectRatios();
		string[] GetSupportedFrameLimits();
	};
};