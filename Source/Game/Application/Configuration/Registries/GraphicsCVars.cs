		...
		public static void Register( ICVarSystemService cvarSystem ) {
			...
			cvarSystem.Register(
				new CVarCreateInfo<ShadowAtlasSize> {
					Name = Nomad.EngineUtils.Constants.CVars.SHADOW_ATLAS_SIZE,
			...
			cvarSystem.Register(
				new CVarCreateInfo<ShadowFilterQuality> {
					Name = Nomad.EngineUtils.Constants.CVars.SHADOW_FILTER_TYPE,
			...
			cvarSystem.Register(
				new CVarCreateInfo<bool> {
					Name = Nomad.EngineUtils.Constants.CVars.PHYSICALLY_BASED_RENDERING,
					DefaultValue = false,
			...
			cvarSystem.Register(
				new CVarCreateInfo<bool> {
					Name = Nomad.EngineUtils.Constants.CVars.FORCE_VERTEX_SHADING,
					DefaultValue = true,
