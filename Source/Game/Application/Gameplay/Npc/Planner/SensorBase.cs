...
namespace Nomad.Game.Application.Gameplay.Npc.Planner.Sensors
{
	/*
	===================================================================================
	...
	*/
	...
	public abstract class SensorBase : ISensor
	{
		...
		*/
		...
		/// <param name="dt"></param>
		public void Tick( INpcAgent agent, float dt )
		{
			ArgumentGuard.ThrowIfNull( agent, nameof( agent ) );
		...
		*/
		...
		/// <param name="agent"></param>
		/// <param name="dt"></param>
		protected abstract void Sense( INpcAgent agent, float dt );
	};
};
