...
namespace Nomad.Game.Application.Gameplay.World {
	...
	*/
	internal sealed class CalendarService {
		...
		private long _absoluteDay;
		private long _absoluteMinute;
