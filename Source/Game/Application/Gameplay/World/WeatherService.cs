...
namespace Nomad.Game.Application.Gameplay.World {
	...
	*/
	...
	internal sealed class WeatherService {
		...
		private long _nextWeatherChangeAtAbsoluteMinute;
		...
		*/
		...
		public WeatherService(
			...
			eventFactory
				.GetEvent<SeasonChangedEventArgs>( EventNames.SEASON_CHANGED, EventNames.NAMESPACE )
		...
		*/
		...
		/// <returns></returns>
		private InternString RollWeather( SeasonDefinition season, InternString? currentWeatherId ) {
