...
namespace Game.Domain.DomainServices.Settings {
	...
	*/
	...
	public sealed class Display : ConfigHandler, IGameService {
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		public readonly CVar<WindowResolution> WindowResolution;
		...
		private readonly IDisplayConfig Updater;
		...
		*/
		...
		public Display( ICVarSystemService cvarSystem, ILoggerService? logger ) {
			...
			WindowResolution = (CVar<WindowResolution>)cvarSystem.Register(
			...
			_cvars = new Lazy<Dictionary<ICVar, object>?>(
				() => new Dictionary<ICVar, object>() {
					...
					{ WindowResolution, Enums.WindowResolution.Res_Native },
			...
			Updater = EngineConfigurationFactory.CreateConfig<GodotDisplay, Display>( this, logger );

			NativeDisplayWidth = (CVar<int>)cvarSystem.Register(
				new CVarCreateInfo<int>(
					name: "display.NativeDisplayWidth",
					defaultValue: Updater.NativeDisplayWidth,
			...
			NativeDisplayHeight = (CVar<int>)cvarSystem.Register(
				new CVarCreateInfo<int>(
					...
					defaultValue: Updater.NativeDisplayHeight,
