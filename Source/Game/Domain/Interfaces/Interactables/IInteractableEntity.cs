...
namespace Nomad.Game.Domain.Interfaces.Entities
{
	...
	*/
	/// <summary>
	/// Optional capability for entities that can be interacted with.
	///
	/// This covers pickup, talk, inspect, loot, open, close, rest, read, consume,
	/// equip, use, activate, and deactivate style interactions.
	/// </summary>
