...
namespace Nomad.Game.Domain.Interfaces.Multiplayer
{
	public interface ILobbyWaitingRoomService : IDisposable
	{
		...
		[Event( nameSpace: "Nomad.Game.Domain.Events.Multiplayer", PayloadName = "LobbyWaitingRoomStateChangedEventArgs" )]
		...
		[Event( nameSpace: "Nomad.Game.Domain.Events.Multiplayer", PayloadName = "LobbyPeerReadyChangedEventArgs" )]
		...
		[Event( nameSpace: "Nomad.Game.Domain.Events.Multiplayer", PayloadName = "LobbyCountdownStartedEventArgs" )]
		...
		[Event( nameSpace: "Nomad.Game.Domain.Events.Multiplayer", PayloadName = "LobbyCountdownCancelledEventArgs" )]
		[EventPayload( "Version", typeof( uint ) )]
		IGameEvent<LobbyCountdownCancelledEventArgs> CountdownCancelled { get; }

		[Event( nameSpace: "Nomad.Game.Domain.Events.Multiplayer", PayloadName = "LobbyGameStartRequestedEventArgs" )]
