...
namespace Nomad.Game.Domain.Interfaces.Multiplayer
{
	public interface IMatchFlowService : IDisposable
	{
		...
		[Event( nameSpace: "Nomad.Game.Domain.Events.Multiplayer.Match", PayloadName = "MatchPhaseChangedEventArgs" )]
		...
		[Event( nameSpace: "Nomad.Game.Domain.Events.Multiplayer.Match" )]
