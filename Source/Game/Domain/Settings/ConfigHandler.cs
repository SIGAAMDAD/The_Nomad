	...
	public class ConfigHandler {
		...
		*/
		public void Load() {
			...
			foreach ( var cvar in Cvars ) {
				switch ( cvar.Key.Type ) {
					case CVarType.Boolean:
						Cvars[ cvar.Key ] = cvar.Key.GetBooleanValue();
						break;
					case CVarType.Int:
						Cvars[ cvar.Key ] = cvar.Key.GetIntegerValue();
						break;
					case CVarType.UInt:
						Cvars[ cvar.Key ] = cvar.Key.GetUIntegerValue();
						break;
					case CVarType.Decimal:
						Cvars[ cvar.Key ] = cvar.Key.GetDecimalValue();
						break;
					case CVarType.String:
						Cvars[ cvar.Key ] = cvar.Key.GetStringValue();
						break;
				}
			}
		}
