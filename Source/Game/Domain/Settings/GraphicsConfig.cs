...
namespace Menus.Settings {
	...
	*/
	...
	public sealed class GraphicsConfig( in IReadOnlyDictionary<ICVar, object> cvars ) : ConfigHandler( in cvars ) {
		...
		public static class Presets {
			public static readonly GraphicsConfig Low = new GraphicsConfig(
				new Dictionary<ICVar, object>() {
					{ Graphics.BakedLights, true },
					{ Graphics.BloomEnabled, false },
					{ Graphics.ForceVertexShading, false },
					{ Graphics.PhysicallyBasedRendering, false },
					{ Graphics.AnimationQuality, AnimationQuality.Low },
					{ Graphics.ParticleQuality, ParticleQuality.Low },
					{ Graphics.ShadowAtlasSize, 1024 },
					{ Graphics.ShadowFilterType, ShadowFilterQuality.Low },
					{ Graphics.ShadowFilterSmooth, 0.0f },
					{ Graphics.FootstepsEnabled, false },
					{ Graphics.Preset, QualitySetting.Low },
					{ Graphics.LightingPreset, LightingQuality.Low }
				}
			);
