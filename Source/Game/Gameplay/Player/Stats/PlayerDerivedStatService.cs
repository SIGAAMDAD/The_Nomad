...
using Nomad.Game.Gameplay.Player.Stats.DerivedStatEvaluators;
...
namespace Nomad.Game.Gameplay.Player.Stats
{
	...
	*/
	...
	internal sealed class PlayerDerivedStatService : IPlayerDerivedStatService
	{
		...
		private readonly PackedBitSet16 _dirty = new PackedBitSet16();

		private readonly PlayerId _playerId;

		private readonly IDisposable _baseStatChanged = null;

		private bool _isDisposed = false;

		public IGameEvent<PlayerDerivedStatChangedEventArgs> DerivedStatChanged => _derivedStatChanged;
		private readonly IGameEvent<PlayerDerivedStatChangedEventArgs> _derivedStatChanged = null;
		...
		*/
		...
		private void EnsureDependencies( DerivedStatType type )
		{
			switch ( type ) {
				...
				case DerivedStatType.BulletTimeDrainRate:
					break;
				default:
