...
namespace Nomad.Game.Gameplay.World.Simulation
{
	...
	*/
	...
	internal sealed class CalendarService : ICalendarService
	{
		...
		private readonly CalendarDefinition _calendarDefinition = null;

		public IGameEvent<YearChangedEventArgs> YearChanged => _yearChanged;
		private readonly IGameEvent<YearChangedEventArgs> _yearChanged = null;

		public IGameEvent<MonthChangedEventArgs> MonthChanged => _monthChanged;
		private readonly IGameEvent<MonthChangedEventArgs> _monthChanged = null;

		public IGameEvent<DayChangedEventArgs> DayChanged => _dayChanged;
		private readonly IGameEvent<DayChangedEventArgs> _dayChanged = null;

		public IGameEvent<HourChangedEventArgs> HourChanged => _hourChanged;
		private readonly IGameEvent<HourChangedEventArgs> _hourChanged = null;

		public IGameEvent<MinuteChangedEventArgs> MinuteChanged => _minuteChanged;
		private readonly IGameEvent<MinuteChangedEventArgs> _minuteChanged = null;
