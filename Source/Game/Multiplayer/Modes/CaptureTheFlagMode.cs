...
using System;
using Nomad.Game.Multiplayer.Modes;
...
namespace Nomad.Game.Multiplayer
{
	...
	*/
	...
	internal sealed class CaptureTheFlagMode : ModeBase, ICaptureTheFlagMode
	{
		...
		private readonly IGameEvent<FlagStatusChangedEventArgs> _flagStatusChanged = null;

		public IGameEvent<CTFRoundBeginEventArgs> CTFRoundBegin => _ctfRoundBegin;
		private readonly IGameEvent<CTFRoundBeginEventArgs> _ctfRoundBegin = null;

		public IGameEvent<CTFRoundEndEventArgs> CTFRoundEnd => _ctfRoundEnd;
		private readonly IGameEvent<CTFRoundEndEventArgs> _ctfRoundEnd = null;
			...
			: base( sessionService, rpcBus, eventBus, messageRegistry, eventFactory )
		{
			...
			_flagStatusChanged = eventFactory
				.GetEvent<FlagStatusChangedEventArgs>(
