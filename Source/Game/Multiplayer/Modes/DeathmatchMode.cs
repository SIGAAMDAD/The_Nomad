...
namespace Nomad.Game.Multiplayer.Modes
{
	/*
	===================================================================================
	...
	*/
	...
	internal sealed class DeathmatchMode : ModeBase, IDeathmatchMode
	{
		...
		public IGameEvent<NewDeathmatchLeaderEventArgs> NewDeathmatchLeader => _newDeathmatchLeader;
		private readonly IGameEvent<NewDeathmatchLeaderEventArgs> _newDeathmatchLeader = null;
