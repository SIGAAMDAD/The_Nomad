...
namespace Game.Presentation.Screens.Settings.Options {
	/*
	===================================================================================
	...
	*/
	...
	public sealed partial class GraphicsOptionsManager : OptionContainer, IOptionManager {
		...
		*/
		...
		/// 
		/// </summary>
		public void Save( ISettingsDataRepository dataRepository ) {
			dataRepository.SetValue( "r.ShadowFilterType", (ShadowFilterQuality)ShadowFilterQuality.Value );
		}
		...
		*/
		...
		public void Init( ISettingsDataRepository dataRepository ) {
		}
		...
		===============
		*/
		private GraphicsConfig CreateConfig() {
			return new GraphicsConfig {
				ShadowFilterType = (ShadowFilterQuality)ShadowFilterQuality.Value,
			};
		}
		...
		===============
		*/
		private void OnPresetValueChanged( in OptionList.ValueChangedEventData args ) {
			Temp = CreateConfig();
		...
		===============
		*/
		private void OnShadowFilterTypeValueChanged( in OptionList.ValueChangedEventData args ) {
			if ( args is OptionNode.ValueChangedEventData valueChanged ) {
		...
		*/
		...
		===============
		*/
		private void OnPhysicallyBasedRenderingToggled( in OptionSlider.ValueChangedEventData args ) {
			Temp = CreateConfig();
			if ( args is OptionNode.ValueChangedEventData valueChanged ) {
				ArgumentNullException.ThrowIfNull( CurrentLightingPreset );
				ArgumentNullException.ThrowIfNull( LightingQuality );
