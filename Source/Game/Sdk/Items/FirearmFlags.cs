...
{
    /// <summary>
    /// <para>Describes the mechanical, handling, reliability, ammunition, stealth, attachment,
    /// and special-purpose traits of a firearm.</para>
    ///
    /// <para>These flags should define what the weapon is allowed to do and which gameplay
    /// systems need to process it. They should not contain mutable runtime state such as
    /// current ammo, heat, dirt, chamber state, jam state, or durability.</para>
    /// </summary>
    [Flags]
