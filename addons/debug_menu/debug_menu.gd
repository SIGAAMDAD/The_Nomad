...
func _process(_delta: float) -> void:
	if visible:
		fps_graph.queue_redraw.call_deferred()
		total_graph.queue_redraw.call_deferred()
		cpu_graph.queue_redraw.call_deferred()
		gpu_graph.queue_redraw.call_deferred()
