...
#	print_debug("time_remaining: ", time_remaining)
#	print_debug("duration * frequency: ", duration * frequency)
#	print_debug("tweens_range: ", tweens_range)
...
#	print_debug("time_remaining: ", time_remaining)
#	print_debug("duration: ", duration)
#	print_debug("frequency: ", frequency)
